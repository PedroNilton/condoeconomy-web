    ...
    <div className="flex flex-col h-full bg-gray-50 relative">
      ...
      <div className="absolute bottom-6 right-6">
        <button 
          ...
          className="w-14 h-14 bg-orange-500 text-white rounded-full flex items-center justify-center shadow-lg hover:bg-orange-600 hover:scale-105 active:scale-95 transition-all"
        >
          ...
          <div className="bg-white w-full max-w-md rounded-t-3xl p-6 shadow-2xl animate-in slide-in-from-bottom-8">
            ...
            <form onSubmit={handleAdd} className="space-y-4">
              ...
              <div className="flex gap-3 pt-4">
                ...
                <button type="submit" disabled={saving} className="flex-1 bg-orange-500 text-white font-bold py-3.5 rounded-xl flex items-center justify-center gap-2 disabled:opacity-70">
