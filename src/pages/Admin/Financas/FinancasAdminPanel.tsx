  ...
  return (
    <div className="space-y-6 h-full overflow-y-auto no-scrollbar">
      ...
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">Resumo do mês atual</p>
      </div>

      {/* Main Cards */}
      <div className="grid grid-cols-2 gap-3">
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center items-center text-center">
          <div className="w-8 h-8 rounded-full bg-green-100 flex items-center justify-center mb-2">
            <TrendingUp className="w-4 h-4 text-green-600" />
          </div>
          <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">Arrecadado</p>
        ...
        <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col justify-center items-center text-center">
          ...
          <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium uppercase tracking-wider">Despesas</p>
          <p className="text-lg font-bold text-gray-800 dark:text-gray-100 mt-1">
      ...
      <div className="bg-white dark:bg-gray-800 p-5 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
        <div className="flex justify-between items-end mb-2">
          <div>
            <p className="text-xs font-semibold text-gray-500 dark:text-gray-400">Meta de Arrecadação</p>
      ...
      <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
        <h3 className="text-lg font-bold text-gray-800 dark:text-gray-100 mb-4">Gestão de Inadimplência e Boletos</h3>
        
        {/* Filtros */}
        <div className="flex flex-col gap-3 bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 p-4 mb-4">
          <div className="relative">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-green-600 outline-none text-sm"
            />
          </div>
          <select 
            className="bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-100 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2 text-sm focus:ring-2 focus:ring-green-600 outline-none"
            value={statusFilter}
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden divide-y divide-gray-50 dark:divide-gray-700">
          {loadingBoletos ? (
            ...
            filteredBoletos.map(boleto => (
              <div key={boleto.id} className="p-4 flex items-center justify-between hover:bg-gray-50 dark:bg-gray-900 transition-colors">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-bold text-gray-800 dark:text-gray-100">{boleto.unidade}</p>
                    <p className="text-[10px] text-gray-500 dark:text-gray-400">Vencimento: {boleto.data}</p>
                  </div>
                </div>
